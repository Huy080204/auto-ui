...
public class BaseJwt implements Serializable {
    ...
    public String toClaim(){
        ...
        return ZipUtils.zipString(accountId+DELIM+restaurantId+DELIM+kind+DELIM+pemission+DELIM+deviceId+DELIM+userKind+DELIM+username+DELIM+tabletKind+DELIM+orderId+DELIM+isSuperAdmin+DELIM+tenantId) ;
    }
